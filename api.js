...
function buscarParticipantes() {
  // ... (seu código para buscar participantes)
}
...
function entrarNaSala(nome) {
  ...
  .then(response => {
    ...
    // Se a entrada na sala for bem-sucedida, inicia a manutenção da conexão
...
buscarParticipantes(); // Esta chamada pode ser feita independentemente do login
